...
const styles = StyleSheet.create({
    ...
    badge: { backgroundColor: 'rgba(255,255,255,0.2)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: radii.pill },
    badgeText: { color: '#fff', fontWeight: '600' },
    refreshBtn: { backgroundColor: '#fff', paddingHorizontal: 14, paddingVertical: 6, borderRadius: radii.pill },
