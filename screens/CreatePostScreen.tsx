...
const styles = StyleSheet.create({
    ...
    coordInput: { flex: 1 },
    outlineButton: { borderWidth: 1, borderColor: colors.primary, paddingVertical: 12, paddingHorizontal: 16, borderRadius: 30, alignItems: 'center', marginBottom: 8 },
    ...
    smallButton: { paddingVertical: 10, paddingHorizontal: 18, borderRadius: 30 },
    primaryButton: { backgroundColor: colors.primary },
    dangerButton: { backgroundColor: colors.danger },
    smallButtonText: { color: '#fff', fontWeight: '600' },
    actionsRow: { flexDirection: 'row', gap: 14, marginTop: 10 },
    submitButton: { flex: 1, backgroundColor: colors.success, paddingVertical: 16, borderRadius: radii.md, alignItems: 'center' },
    submitButtonText: { color: '#fff', fontSize: 16, fontWeight: '600' },
    cancelButton: { paddingVertical: 16, paddingHorizontal: 24, borderRadius: radii.md, backgroundColor: colors.danger, alignItems: 'center' },
    ...
    outlineSmall: { backgroundColor: 'transparent', borderWidth: 1, borderColor: colors.primary },
    prefillButton:{ alignSelf:'flex-end', marginBottom:8, backgroundColor: colors.primary, paddingVertical:8, paddingHorizontal:16, borderRadius:20 },
