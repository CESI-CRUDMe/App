...
const styles = StyleSheet.create({
    ...
    badge: { backgroundColor: 'rgba(255,255,255,0.25)', alignSelf: 'flex-start', paddingHorizontal: 14, paddingVertical: 6, borderRadius: 24 },
    ...
    button: { backgroundColor: colors.danger, paddingVertical: 14, borderRadius: radii.md, alignItems: 'center' },
